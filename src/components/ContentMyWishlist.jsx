    ...
    <Layout>
      <div className="bg-[#EEEEEE] p-0 md:py-[50px]">
        <div className="flex gap-[20px]">
          ...
          <div className="w-full md:w-2/3 p-8 m-0 md:p-[100px] md:mr-[120px] bg-[#ffff] rounded-none md:rounded-[30px] flex gap-[50px] flex-col shadow-md">
                  ...
                  return (
                    <div key={item.id} className="flex justify-between">
                      <div className="flex gap-[25px]">
                        <div className="p-[10px] text-center font-semibold text-[#ff8900] max-h-16">
                          <div>15</div>
